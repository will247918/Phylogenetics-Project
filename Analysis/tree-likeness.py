# -*- coding: utf-8 -*-
"""
Created on Mon Feb 26 14:23:08 2024
...
class delta_plot():
    ...
    def area_length_mean(self):
        ...
        for quartet in itertools.combinations(s,4):
            ...
            if s*l>=0 and s/l>=0:
                ...
                #Just the area
                #array_value = s*l
                list_delta_new.append(array_value)
                list_delta_old.append(old_delta)
                #print(quartet)
                #print(s/l)
                #print(s*l)
                #print(quartet_matrix)
        ...
        norm_data=[]
        for i in list_delta_new:
            norm_data.append(200*i)
            
        print(f'Length of list is {len(norm_data)}')
        return norm_data,list_delta_old,area_list
    ...
    def delta_plot1(self):
        ...
        overall_delt = plt.hist(delta_values_list,bins=10,density=True,ec='White')
    ...
    def plot_treelikeness(self):
        new_delta_list = self.area_length_mean()[0]
        old_delta_list = self.area_length_mean()[1]
        area_list = np.array(self.area_length_mean()[2])*1000
        #print(f'new delta list is {new_delta_list}')
        #print(len(old_delta_list))
        plt_treelikeness = plt.scatter(old_delta_list,area_list,s=15)
        plt.scatter(0.897200,3.9832835*10**-3,color='Red')
        plt.xlabel("Delta values")
        plt.ylabel("Area of quartets")
        
        
        return plt_treelikeness
    ...
    def cut_off(self):
        ...
        list_cutoff=[]
        #list_area = self.list_area()
        delta_values_list = self.area_length_mean()[1]
